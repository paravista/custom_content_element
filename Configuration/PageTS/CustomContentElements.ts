...
mod.wizards.newContentElement.wizardItems.common {
	elements {
		text_image_left {
			...
			title = LLL:EXT:custom_content_element/Resources/Private/Language/locallang_db.xlf:ce.text_image_left.title
			description = LLL:EXT:custom_content_element/Resources/Private/Language/locallang_db.xlf:ce.text_image_left.description
